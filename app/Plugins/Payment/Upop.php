...
namespace app\common\modules\payment;

load_lang('payment/upop');
...
eot;
    ...
    public function signBySecureKey(&$params)
    {
    ...
    public function validateBySecureKey($params)
    {
        // 测试待删除
        // $this->payment['upop_cert_pwd'] = '88888888';
        $isSuccess = false;
     ...
     */
    public function getVerifyCertByCertId($certId)
    {
    ...
    public function verifyAndGetVerifyCert($certBase64String)
    {
        ...
        } elseif ($this->company != $cn && "00040000:SIGN" != $cn) {
            $this->logInfo("cer owner is not CUP:" . $cn);
            return null;
        }
    ...
    public function getCertInfoFromPfx($key)
    {
