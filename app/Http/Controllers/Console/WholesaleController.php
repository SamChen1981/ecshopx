...
class Wholesale extends Init
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->assign('ur_here', $GLOBALS['_LANG']['wholesale_list']);
            $this->assign('action_link', array('href' => 'wholesale.php?act=add', 'text' => $GLOBALS['_LANG']['add_wholesale']));
            $this->assign('action_link2', array('href' => 'wholesale.php?act=batch_add', 'text' => $GLOBALS['_LANG']['add_batch_wholesale']));
        ...
        elseif ($_REQUEST['act'] == 'batch_add') {
            ...
            /* 显示模板 */
            $this->assign('ur_here', $GLOBALS['_LANG']['add_wholesale']);
        ...
        elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if ($is_add) {
                ...
                $this->assign('ur_here', $GLOBALS['_LANG']['edit_wholesale']);
            }
            $href = 'wholesale.php?act=list';
            if (!$is_add) {
