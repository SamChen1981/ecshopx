...
class mdl_serverinfo
{
    ...
    public function test_basic($score)
    {
        $items['操作系统'] = PHP_OS;
    ...
    public function test_php(&$score)
    {
    ...
    public function test_server_req(&$score)
    {
    ...
    public function test_php_req(&$score)
    {
        $rst = PHP_OS!='WINNT';
    ...
    public function doHttpQuery($uri)
    {
