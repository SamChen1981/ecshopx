...
class Index extends Init
{
    public function index()
    {
        ...
        if (!$smarty->is_cached('index.dwt', $cache_id)) {
            ...
            $smarty->assign('invoice_list', $this->index_get_invoice_query());  // 发货查询
            $smarty->assign('new_articles', $this->index_get_new_articles());   // 最新文章
            $smarty->assign('group_buy_goods', $this->index_get_group_buy());      // 团购商品
            $smarty->assign('auction_list', $this->index_get_auction());        // 拍卖活动
