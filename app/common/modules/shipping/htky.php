...
if (isset($set_modules) && $set_modules == true) {
    ...
    $modules[$i]['configure'] = array(
        array('name' => 'item_fee', 'value' => 14), /* 单件商品的配送费用 */
        array('name' => 'base_fee', 'value' => 14), /* 1000克以内的价格           */
        array('name' => 'step_fee', 'value' => 6),  /* 续重每1000克增加的价格 */
    );
