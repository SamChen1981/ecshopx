...
//         $cert->certId = $certId;
    ...
    public static function verifyAndGetVerifyCert($certBase64String)
    {
        ...
        } elseif (COMPANY != $cn && "00040000:SIGN" != $cn) {
            $logger->LogInfo("cer owner is not CUP:" . $cn);
            return null;
        }
        ...
        $result = openssl_x509_checkpurpose($certBase64String, X509_PURPOSE_ANY, array(app()->basePath() . '/app/Services/Payment/Unionpaynew/sdk/acp_prod_root.cer', app()->basePath() . '/app/Services/Payment/Unionpaynew/sdk/acp_prod_middle.cer'));
        if ($result === false) {
