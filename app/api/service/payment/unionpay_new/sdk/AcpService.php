...
class AcpService
{
    ...
    public static function signByCertInfo(&$params, $cert_path, $cert_pwd)
    {
        ...
        if ($params['signMethod']=='01') {
            ...
            openssl_pkcs12_read($cert_path, $certs, $cert_pwd);
            $x509data = $certs['cert'];
    ...
    public static function validateBySecureKey($params, $secureKey)
    {
        $logger = LogUtil::getLogger();
        $isSuccess = false;
     ...
     * @return 是否成功
     */
    public static function validateAppResponse($jsonData)
    {
...
eot;
     ...
     * @return unknown
     */
    public static function encryptData($data, $cert_path=null)
    {
        if ($cert_path == null) {
            $cert_path = SDKConfig::getSDKConfig()->encryptCertPath;
        }
     ...
     * @return unknown
     */
    public static function decryptData($data, $cert_path=null, $cert_pwd=null)
    {
        if ($cert_path == null) {
     ...
     * @param unknown_type $params
     */
    public static function deCodeFileContent($params, $fileDirectory)
    {
        $logger = LogUtil::getLogger();
