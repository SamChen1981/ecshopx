...
$template_files = array(
    ...
    'gallery.view.php',
    'goods.view.php',
    'group_buy_goods.view.php',
    'group_buy_flow.view.php',
    'group_buy_list.view.php',
    'user_passport.view.php',
    'pick_out.view.php',
    'receive.view.php',
    'respond.view.php',
    'search.view.php',
    ...
    'user.view.php',
    'tag_cloud.view.php',
    'user_transaction.view.php',
    'style.css',
    'auction_list.view.php',
    'auction.view.php',
    'message_board.view.php',
    'exchange_list.view.php',
);

/* 每个模板允许设置的库项目 */
$page_libs = array(
    'article' => array(
        '/library/ur_here.view.php' => 0,
        '/library/search_form.view.php' => 0,
        '/library/member.view.php' => 0,
        '/library/recommend_best.view.php' => 3,
        '/library/recommend_hot.view.php' => 3,
        '/library/comments.view.php' => 0,
        '/library/goods_related.view.php' => 0,
        '/library/recommend_promotion.view.php' => 3,
        '/library/history.view.php' => 0,
    ),
    'article_cat' => array(
        '/library/ur_here.view.php' => 0,
        '/library/search_form.view.php' => 0,
        '/library/member.view.php' => 0,
        '/library/category_tree.view.php' => 0,
        '/library/top10.view.php' => 0,
        '/library/history.view.php' => 0,
        '/library/recommend_best.view.php' => 3,
        '/library/recommend_hot.view.php' => 3,
        '/library/recommend_promotion.view.php' => 3,
        '/library/promotion_info.view.php' => 0,
        '/library/cart.view.php' => 0,
        '/library/vote_list.view.php' => 0,
        '/library/article_category_tree.view.php' => 0,
    ),
    'brand' => array(
        '/library/ur_here.view.php' => 0,
        '/library/search_form.view.php' => 0,
        ...
        '/library/history.view.php' => 0,
        '/library/recommend_best.view.php' => 3,
        '/library/goods_list.view.php' => 0,
        '/library/pages.view.php' => 0,
        '/library/recommend_promotion.view.php' => 3,
        '/library/promotion_info.view.php' => 0,
        '/library/cart.view.php' => 0,
        '/library/vote_list.view.php' => 0,
    ...
    'index' => array(
        ...
        '/library/search_form.view.php' => 0,
        '/library/member.view.php' => 0,
        '/library/new_articles.view.php' => 0,
        '/library/category_tree.view.php' => 0,
        '/library/top10.view.php' => 0,
        '/library/invoice_query.view.php' => 0,
        '/library/recommend_best.view.php' => 3,
        '/library/recommend_new.view.php' => 3,
        '/library/recommend_hot.view.php' => 3,
        '/library/recommend_promotion.view.php' => 4,
        '/library/group_buy.view.php' => 3,
        '/library/auction.view.php' => 3,
        '/library/brands.view.php' => 3,
        '/library/promotion_info.view.php' => 0,
        '/library/cart.view.php' => 0,
        '/library/order_query.view.php' => 0,
        '/library/email_list.view.php' => 0,
        '/library/vote_list.view.php' => 0
    ),
    'goods' => array(
        '/library/ur_here.view.php' => 0,
        ...
        '/library/member.view.php' => 0,
        '/library/category_tree.view.php' => 0,
        '/library/goods_attrlinked.view.php' => 0,
        '/library/history.view.php' => 0,
        '/library/goods_fittings.view.php' => 0,
        '/library/goods_gallery.view.php' => 0,
        '/library/goods_tags.view.php' => 0,
        '/library/comments.view.php' => 0,
        '/library/bought_goods.view.php' => 0,
        '/library/bought_note_guide.view.php' => 0,
        '/library/goods_related.view.php' => 0,
        '/library/goods_article.view.php' => 0,
        '/library/relatetag.view.php' => 0,
    ),
    'search_result' => array(
        '/library/ur_here.view.php' => 0,
        '/library/search_form.view.php' => 0,
        ...
        '/library/promotion_info.view.php' => 0,
        '/library/cart.view.php' => 0,
        '/library/search_result.view.php' => 0,
        '/library/top10.view.php' => 0,
        '/library/search_advanced.view.php' => 0,
        '/library/history.view.php' => 0,
        '/library/pages.view.php' => 0,
    ),
    'tag_cloud' => array(
    ...
    'message_board' => array(
        ...
        '/library/top10.view.php' => 0,
        '/library/history.view.php' => 0,
        '/library/message_list.view.php' => 10,
    ),
    'exchange_list' => array(
        '/library/ur_here.view.php' => 0,
        '/library/cart.view.php' => 0,
        ...
        '/library/history.view.php' => 0,
        '/library/pages.view.php' => 0,
        '/library/exchange_hot.view.php' => 5,
        '/library/exchange_list.view.php' => 0,
    ),
);
    ...
    if ($xml_content = @file_get_contents(ROOT_PATH . 'themes/' . $GLOBALS['_CFG']['template'] . '/libs.xml')) {
        ...
        for (; $i < sizeof($vals); $i++) {                                      //找到相应模板文件的位置
            if ($vals[$i]['tag'] == 'FILE' && isset($vals[$i]['attributes'])) {
                if ($vals[$i]['attributes']['NAME'] == $curr_template . '.view.php') {
                    break;
                }
            }
        }
