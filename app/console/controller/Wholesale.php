...
class Wholesale extends Init
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            /* 显示商品列表页面 */
            assign_query_info();
            return $GLOBALS['smarty']->display('wholesale_list.view.php');
        }
        ...
        elseif ($_REQUEST['act'] == 'batch_add') {
            ...
            return $GLOBALS['smarty']->display('wholesale_batch_info.view.php');
        }
        ...
        elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $GLOBALS['smarty']->assign('action_link', array('href' => $href, 'text' => $GLOBALS['_LANG']['wholesale_list']));
            assign_query_info();
            return $GLOBALS['smarty']->display('wholesale_info.view.php');
        }
