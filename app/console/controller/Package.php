...
class Package extends Init
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->assign('action_link', array('text' => $GLOBALS['_LANG']['14_package_list'], 'href' => 'package.php?act=list'));
            $this->assign('cat_list', cat_list());
            $this->assign('brand_list', get_brand_list());
            $this->assign('form_action', 'insert');

            assign_query_info();
            return $this->display('package_info.view.php');
        ...
        elseif ($_REQUEST['act'] == 'edit') {
            ...
            $this->assign('action_link', array('text' => $GLOBALS['_LANG']['14_package_list'], 'href' => 'package.php?act=list&' . list_link_postfix()));
            $this->assign('cat_list', cat_list());
            $this->assign('brand_list', get_brand_list());
        ...
        elseif ($_REQUEST['act'] == 'list') {
            ...
            $this->assign('action_link', array('text' => $GLOBALS['_LANG']['package_add'], 'href' => 'package.php?act=add'));
            ...
            assign_query_info();
            return $this->display('package_list.view.php');
        }
