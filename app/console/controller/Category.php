    ...
    public function index()
    {
            ...
            if ($GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('category'), $cat) !== false) {
                ...
                if ($cat['show_in_nav'] == 1) {
                    ...
                    $sql = "INSERT INTO " . $GLOBALS['ecs']->table('nav') .
                        ...
                        " VALUES('" . $cat['cat_name'] . "', 'c', '" . $GLOBALS['db']->insert_id() . "','1','$vieworder','0', '" . build_uri('category', array('cid' => $cat_id), $cat['cat_name']) . "','middle')";
        ...
        if ($_REQUEST['act'] == 'update') {
            ...
            if ($GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('category'), $cat, 'UPDATE', "cat_id='$cat_id'")) {
                ...
                /* 提示信息 */
                $link[] = array('text' => $GLOBALS['_LANG']['back_list'], 'href' => 'category.php?act=list');
        ...
        if ($_REQUEST['act'] == 'move_cat') {
            ...
            if ($cat_id == 0 || $target_cat_id == 0) {
                $link[] = array('text' => $GLOBALS['_LANG']['go_back'], 'href' => 'category.php?act=move');
            ...
            if ($GLOBALS['db']->query($sql)) {
                ...
                /* 提示信息 */
                $link[] = array('text' => $GLOBALS['_LANG']['go_back'], 'href' => 'category.php?act=list');
