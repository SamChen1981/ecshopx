...
('index', '左边区域', '/library/vote_list', 8, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/email_list', 9, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/order_query', 6, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/cart', 0, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/promotion_info', 3, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/auction', 4, 0, 3, 0, 'default', ''),
('index', '左边区域', '/library/group_buy', 5, 0, 3, 0, 'default', ''),
('index', '', '/library/recommend_promotion', 0, 0, 4, 0, 'default', ''),
('index', '右边主区域', '/library/recommend_hot', 2, 0, 10, 0, 'default', ''),
('index', '右边主区域', '/library/recommend_new', 1, 0, 10, 0, 'default', ''),
('index', '右边主区域', '/library/recommend_best', 0, 0, 10, 0, 'default', ''),
('index', '左边区域', '/library/invoice_query', 7, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/top10', 2, 0, 0, 0, 'default', ''),
('index', '左边区域', '/library/category_tree', 1, 0, 0, 0, 'default', ''),
('index', '', '/library/brands', '0', '0', '11', '0', 'default', ''),
('category', '左边区域', '/library/category_tree', 1, 0, 0, 0, 'default', ''),
('category', '右边区域', '/library/recommend_best', 0, 0, 5, 0, 'default', ''),
('category', '右边区域', '/library/goods_list', 1, 0, 0, 0, 'default', ''),
('category', '右边区域', '/library/pages', 2, 0, 0, 0, 'default', ''),
('category', '左边区域', '/library/cart', 0, 0, 0, 0, 'default', ''),
('category', '左边区域', '/library/price_grade', 3, 0, 0, 0, 'default', ''),
('category', '左边区域', '/library/filter_attr', 2, 0, 0, 0, 'default', '');
